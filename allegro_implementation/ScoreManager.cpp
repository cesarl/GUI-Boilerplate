...
inline void				selectScore(GuiComponent *c)
{
  ...
  if (gg)
    {
      gg->setColor(al_map_rgb(255, 0, 255));
    }
}
...
inline void				unselectScore(GuiComponent *c)
{
  ...
  if (g)
    {
      g->setColor(al_map_rgb(150, 150, 150));
    }
}
...
inline void				selectExit(GuiComponent *c)
{
  ...
  if (g)
    {
      g->setColor(al_map_rgb(0,255,255));
    }
}
...
GuiSelectableGroup			*ScoreManager::getGuiList()
{
  ...
  exit->setupText("Exit", FontManager::getInstance()->get("assets/fonts/LilitaOne-Regular.ttf", 40));
  ...
  while (it != this->list_.end())
    {
      FontManager::getInstance()->load("assets/fonts/LilitaOne-Regular.ttf", 30);
      ...
      player->setFont(FontManager::getInstance()->get("assets/fonts/LilitaOne-Regular.ttf", 30));
      date->setFont(FontManager::getInstance()->get("assets/fonts/LilitaOne-Regular.ttf", 30));
      score->setFont(FontManager::getInstance()->get("assets/fonts/LilitaOne-Regular.ttf", 30));
